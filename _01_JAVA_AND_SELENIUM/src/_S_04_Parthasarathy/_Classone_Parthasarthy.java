...
public class _Classone_Parthasarthy {
	...
	@Test
  public void f() throws InterruptedException, IOException, JXLException {
	...
	/*@Test
	  public void f1() throws InterruptedException, IOException, JXLException {
		FileInputStream k=new FileInputStream("D:\\raj1.xls");
		Workbook l=Workbook.getWorkbook(k);
		Sheet s=l.getSheet(0);
		int count=s.getRows();
		for(int i=1;i<count;i++) {
